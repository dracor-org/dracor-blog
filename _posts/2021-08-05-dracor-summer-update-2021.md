...
date: 2021-08-05
author: [lehkost, cmil, markschwindt]
excerpt: >
  Next iteration of the DraCor website and new API functions that make it
  much easier to access our data for research. Frontend 1.1.0, API 0.82.0.
canonical_url: https://weltliteratur.net/dracor-summer-update-2021/
original_site: weltliteratur.net
---

![DraCor 2021](https://weltliteratur.net/images/dracor/dracor-2021-mobile-mockup-05.jpg)
