...
excerpt: >
  The DraCor API reaches version 1.0.0 — streamlined, consistent, and ready
  for sustainable research use. The legacy API remains available under /v0.
canonical_url: https://weltliteratur.net/streamlining-the-dracor-api/
